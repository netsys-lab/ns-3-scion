...
#ifndef SCION_QUEUE_DISC_ITEM_H
#define SCION_QUEUE_DISC_ITEM_H
 ...
 *
 * SCIONQueueDiscItem is a subclass of QueueDiscItem which stores SCION packets.
 ...
 */
class SCIONQueueDiscItem : public QueueDiscItem
{
  public:
    /**
     ...
     */
    SCIONQueueDiscItem(Ptr<Packet> p,
                      const Address& addr,
                      uint16_t protocol,
                      const SCIONHeader& header);

    ~SCIONQueueDiscItem() override;

    // Delete default constructor, copy constructor and assignment operator to avoid misuse
    SCIONQueueDiscItem() = delete;
    SCIONQueueDiscItem(const SCIONQueueDiscItem&) = delete;
    SCIONQueueDiscItem& operator=(const SCIONQueueDiscItem&) = delete;
     ...
     */
    const SCIONHeader& GetHeader() const;
    ...
    /*
     * The values for the fields of the SCION header are taken from m_header and
